...
| 17 | Sit on the bench to rest / take the room in | ✅ | 🟡 | **Prototype:** two tappable benches move camera to a seated rest view with minimal rest UI | Needs HTML/menu entry + free-look decision before accessible-complete |
