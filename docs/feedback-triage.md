...
| 17 | Sit on the bench to rest / take the room in | ✅ | 🟡 | **Prototype:** two tappable benches move camera to a seated rest view | Needs HTML/menu entry before it is accessible-complete |
